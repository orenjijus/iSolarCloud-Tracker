  ...
  create  table "MMSR"."public"."mart_site_performance_daily__dbt_tmp"
...
WITH daily_inverter_summary AS (
    ...
    FROM "MMSR"."public"."mart_inverter_performance_5min"
...
daily_meter_summary AS (
    SELECT 
        ...
        COUNT(*) as measurement_count
    FROM "MMSR"."public"."mart_meter_performance_5min"
    GROUP BY date_key, site_name, metric_id
)
