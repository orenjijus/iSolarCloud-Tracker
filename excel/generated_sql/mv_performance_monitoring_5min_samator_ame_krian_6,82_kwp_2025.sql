...
-- Site: Samator Ame Krian 6,82 kWp
-- Year: 2025
-- Generated: C:\Users\Administrator\Documents\Code\MMSR API - Server MA\excel\generate_mv_performance_monitoring.py
-- ============================================================================

CREATE MATERIALIZED VIEW IF NOT EXISTS mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025 AS
WITH 
-- ============================================================================
...
meter_pivot AS (
    ...
    WHERE m.site_name = 'Samator Ame Krian 6,82 kWp'
...
sensor_pivot AS (
    ...
    WHERE s.site_name = 'Samator Ame Krian 6,82 kWp'
...
inverter_pivot AS (
    SELECT 
        ...
        MAX(CASE 
            WHEN i.asset_id = 'ISO_1722752_1_1_1'
    ...
    WHERE i.site_name = 'Samator Ame Krian 6,82 kWp'
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025_unique_timestamp 
    ON mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025(timestamp);

CREATE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025_date 
    ON mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025(date_key);

CREATE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025_date_timestamp 
    ON mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025(date_key, timestamp);

-- ============================================================================
-- Grant Permissions
-- ============================================================================

GRANT SELECT ON mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025 TO PUBLIC;

-- ============================================================================
-- Create View Wrapper
-- ============================================================================

CREATE OR REPLACE VIEW mart.vw_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025 AS
SELECT * 
FROM mart.mv_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025
ORDER BY timestamp;

GRANT SELECT ON mart.vw_performance_monitoring_5min_samator_ame_krian_6,82_kwp_2025 TO PUBLIC;
