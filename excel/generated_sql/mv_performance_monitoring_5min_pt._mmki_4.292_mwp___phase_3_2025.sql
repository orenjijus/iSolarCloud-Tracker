...
CREATE MATERIALIZED VIEW IF NOT EXISTS mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025 AS
WITH 
-- ============================================================================
...
meter_pivot AS (
    ...
    WHERE m.site_name = 'PT. MMKI 4.292 MWP - Phase 3'
...
sensor_pivot AS (
    ...
    WHERE s.site_name = 'PT. MMKI 4.292 MWP - Phase 3'
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025_unique_timestamp 
    ON mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025(timestamp);

CREATE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025_date 
    ON mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025(date_key);

CREATE INDEX IF NOT EXISTS idx_mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025_date_timestamp 
    ON mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025(date_key, timestamp);

-- ============================================================================
-- Grant Permissions
-- ============================================================================

GRANT SELECT ON mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025 TO PUBLIC;

-- ============================================================================
-- Create View Wrapper
-- ============================================================================

CREATE OR REPLACE VIEW mart.vw_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025 AS
SELECT * 
FROM mart.mv_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025
ORDER BY timestamp;

GRANT SELECT ON mart.vw_performance_monitoring_5min_pt._mmki_4.292_mwp___phase_3_2025 TO PUBLIC;
